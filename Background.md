...
## Key Stakeholders
The following groups are most affected by this decision:

* **HIAA Senior Leadership Team:** Primary decision-makers with the authority to allocate incentive funding.
* **Tourism Nova Scotia:** Focuses on visitor spending; they prioritize high-value European travelers.
* **Regional Business Community:** Relies on consistent, year-round U.S. hub access for trade and talent recruitment.
* **Airline Partners:** Carriers like WestJet, Air Canada, and United, who require financial certainty to commit aircraft to the Halifax market.
* **Nova Scotia Provincial Government:** Interested in the airport's role as an engine for job creation and tax revenue.

---

## 3. References

Halifax International Airport Authority. (2025). *2024 Annual report: Connecting Atlantic Canada to the world*. https://www.halifaxstanfield.ca/annual-reports

Halifax International Airport Authority. (2026). *Quarterly traffic statistics: Q4 2025 results and 2026 outlook*. [Internal Corporate Document].

Tourism Nova Scotia. (2024). *2023 Visitor profile and spending report*. https://www.tourismns.ca/research

Tourism Nova Scotia. (2025). *International market trends: The rise of transatlantic tourism*. https://www.tourismns.ca/market-trends

---

## 4. Planned Datasets
*The following data sources will be used to evaluate the trade-offs in this analysis:*

1.  **HIAA Historical Passenger Volumes:** Monthly data on international vs. transborder traffic (2019–2025).
2.  **Statistics Canada Table 23-10-0253-01:** Air carrier traffic at Canadian airports (specifically YHZ).
3.  **Tourism Nova Scotia Visitor Exit Surveys:** Spending patterns and seasonality data for European and U.S. visitors.
